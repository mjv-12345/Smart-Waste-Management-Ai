code = [
    ...
    "    return {'status': 'ready' if engine.ready else 'models_not_trained', 'models_ready': engine.ready, 'metrics': metrics}",
    "",
    ...
    "    stops = [s.dict() for s in payload.stops]",
    "    vehicle = payload.vehicle.dict()",
    "    result = optimize_route(stops, vehicle, payload.depot_index, use_ml=engine.ready)",
...
print('backend/main.py written successfully')